package com.pulse.notification.config.trace.aop;

import com.pulse.notification.util.TraceUtil;
...
public class TraceOutboxKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(com.pulse.notification.config.trace.annotation.TraceOutboxKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("Notification [kafka-consume] outbox process change [PROCESSED]")
