...
public class TraceZeroPayloadKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(com.pulse.notification.config.trace.annotation.TraceZeroPayloadKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("Notification [kafka-consume] zeropayload gRPC call")
