...
import com.pulse.notification.config.trace.grpc.GrpcMetadata;
...
public class TraceGrpcServerAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around("@annotation(com.pulse.notification.config.trace.annotation.TraceGrpcServer)")
    public Object traceGrpcServer(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Span span = tracer.spanBuilder("Notification [grpc] server response")
