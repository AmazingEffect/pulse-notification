...
/**
 * 댓글이 생성되면 이벤트를 수신하여 알림 db에 저장하는 Kafka 리스너
 */
@Slf4j
...
public class CommentMessageListener {
    ...
    @TraceOutboxKafka
    @KafkaListener(
            topics = {"comment-created-outbox"},
            groupId = "notification-comment-create",
            containerFactory = "kafkaListenerContainerFactory"
    )
    public void saveCommentCreateNotification(
